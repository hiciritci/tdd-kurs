...
public sealed class CreateProductDtoValidator : AbstractValidator<CreateProductDto>
{
    public CreateProductDtoValidator()
    {
        ...
        RuleFor(p => p.Stock).GreaterThan(0).WithMessage("Sok adedi 0 dan büyük olmalıdır");
        RuleFor(p => p.Price).GreaterThan(0).WithMessage("Sok adedi 0 dan büyük olmalıdır");
    }
}
